...
<fieldset class="mb-3">
    ...
    <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                {{ Form::label('chart_account_id', _lang('income_type') , ['class' => 'col-form-label required']) }}
                {{ Form::select('chart_account[id]',$chartaccount, null, ['class' => 'form-control select', 'data-placeholder' =>  _lang('income_type'), 'required' => '', 'data-parsley-errors-container' => '#parsley_district_error_area']) }}
