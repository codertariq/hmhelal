        ...
        <div class="col-lg-12">
           ...
           <div class="col-lg-12">
              <div class="form-group">
                ...
                {{ Form::select('type',['Income' => 'Income','Expense'=>'Expense'], null, ['class' => 'form-control select', 'data-placeholder' =>  _lang('type'), 'required' => '', 'data-parsley-errors-container' => '#parsley_district_error_area']) }}
