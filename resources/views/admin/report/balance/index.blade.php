...
<div class="card border-top-success rounded-top-0" id="table_card">
	...
	<div class="card-body">
		{!! Form::open(['route' => $route.'balance', 'class' => 'form-validate-jquery', 'id' => 'content_form', 'files' => true, 'method' => 'POST','target'=>'_blank']) !!}
		<div class="row">
			<div class="col-lg-6">
			 <div class="form-group">
                {{ Form::label('from', _lang('date_form') , ['class' => 'col-form-label required']) }}
                {{ Form::text('from', Null, ['class' => 'form-control date', 'placeholder' =>  _lang('date_orm'), 'required' => '']) }}
            </div>
			</div>
