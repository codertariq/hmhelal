...
$js = ['report'];
@endphp
@extends('layouts.app', ['title' => _lang('income_report'), 'modal' => 'full'])
@section('page.header')
	...
	<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
		<div class="d-flex">
			<div class="breadcrumb">
				...
				<span class="breadcrumb-item active">{{ _lang('income_report') }}</span>
			</div>
...
<div class="card-body" id="div1">
   <h5 class="text-center m-2"><b>{{_lang('total_income')}}:</b> {{ date("F d Y",strtotime($date1))}} <b>{{_lang('To')}}</b> {{ date("F d Y",strtotime($date2))}}</h5>
