...
use App\Http\Requests\Configuration\Master\ActRequest;
use App\Repositories\Configuration\Master\ActRepository;
...
class ActController extends Controller {
	...
	public function __construct(
		...
		$this->repo = $repo;
		$this->view = 'configuration.master.act.';
	}
	...
	public function store(ActRequest $request) {
		...
		if ($this->request->ajax()) {
			...
			return $this->success(['message' => _lang('Act Added Successfull.'), 'model' => $model]);
		} else {
			return abort(404);
		}
	}
	...
	public function update(ActRequest $request, $id) {
		...
		if ($this->request->ajax()) {
			...
			return $this->success(['message' => _lang('Act Updated Successfull.')]);
		} else {
			return abort(404);
		}
	}
	...
	public function destroy($id) {
		...
		if ($this->request->ajax()) {
			...
			return $this->success(['message' => _lang('Act Deleted Successfull')]);
		} else {
			return abort(404);
		}
	}
